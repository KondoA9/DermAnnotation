...
const config: NuxtConfig = {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:description', property: 'og:description', content: 'Derm Annotation is an image annotation tool for semantic segmentation. Various support functions enable efficient annotation work.' },
